...
const ButtonsPanel = memo(({startStopButtonLabel, onStartStopClicked, onResetClicked}) =>
  <aside className={"basis-3/4 flex flex-col"}>
    ...
    <div className={"p-4 basis-1/4"} onClick={onResetClicked}>
      <StandardButton>
        Reset
      </StandardButton>
    </div>
...
const DisplayPanel = ({displayedTime, isTimerRunning}) => {
